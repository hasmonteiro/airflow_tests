...
default_args = {
    ...
    'start_date': datetime(2021, 9, 29, 19), #UTC hour
...
task_get_data = BashOperator(
    task_id='get-data',
    bash_command='curl https://download.inep.gov.br/microdados/Enade_Microdados/microdados_enade_2019.zip -o /home/alunoigti/airflow/data/microdados_enade_2019.zip',
    dag=dag
)

# Unzip
def unzip_file():
    with zipfile.ZipFile('/home/alunoigti/airflow/data/microdados_enade_2019.zip', 'r') as zipped:
        zipped.extractall('/home/alunoigti/airflow/data')
...
task_write_to_dw = PythonOperator(
    task_id='write_dw',
...
task_join_data >> task_write_to_dw
